...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  const t = await getTranslations({
    locale,
    namespace: "places.restaurant.meta",
  });
    ...
    <main className="min-h-screen bg-[#050505] text-white relative font-serif selection:bg-[#D4AF37] selection:text-black">
      ...
      <div className="relative h-[60vh] overflow-hidden">
        ...
        <div className="absolute inset-0 z-20 flex flex-col items-center justify-center text-center px-4">
          <div className="inline-block bg-black/80 text-[#FFD700] px-8 py-3 border-2 border-[#FFD700] tracking-[0.2em] text-sm mb-8 font-medium uppercase shadow-[0_0_20px_rgba(212,175,55,0.3)]">
