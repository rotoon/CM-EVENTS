...
function ExhibitionsContent() {
  return (
    <div className="min-h-screen bg-white relative">
      {/* Gallery Grid Background Overlay */}
      <div
        ...
        <div className="flex flex-col lg:flex-row justify-between items-start gap-8">
          <div className="flex-1">
            ...
            <p className="font-bold text-xl md:text-2xl max-w-2xl border-l-8 border-neo-pink pl-6 italic">
              Curated art, exhibitions, and creative energy. <br />
              From local galleries to experimental workshops.
            </p>
          </div>

          {/* Museum Label Element */}
          <div className="w-full lg:w-72 bg-white border-4 border-neo-black p-6 shadow-neo rotate-1 self-center lg:self-end">
            ...
            <div className="space-y-3">
              <div className="flex justify-between items-center text-sm font-bold">
                <span className="opacity-60 uppercase">Admission</span>
                <span className="text-neo-pink">FREE / TICKET</span>
              </div>
              <div className="flex justify-between items-center text-sm font-bold">
                <span className="opacity-60 uppercase">Hours</span>
                <span>10AM - 8PM</span>
              </div>
              <div className="flex justify-between items-center text-sm font-bold">
                <span className="opacity-60 uppercase">Curated by</span>
                <span className="italic">HYPE Scouts</span>
              </div>
            </div>
